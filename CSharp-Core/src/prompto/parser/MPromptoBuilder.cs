...
namespace prompto.parser
{
    ...
    public class MPromptoBuilder : MParserBaseListener
    {
        ...
        public override void ExitDbIdType(MParser.DbIdTypeContext ctx)
        {
        ...
        public override void ExitDoc_entry_list(MParser.Doc_entry_listContext ctx)
        {
        ...
        public override void ExitDoc_entry(MParser.Doc_entryContext ctx)
        {
        ...
        public override void ExitDocKeyIdentifier(MParser.DocKeyIdentifierContext ctx)
        {
        ...
        public override void ExitDocKeyText(MParser.DocKeyTextContext ctx)
        {
        ...
        public override void ExitCompareExpression(MParser.CompareExpressionContext ctx)
        {
            IExpression left = GetNodeValue<IExpression>(ctx.left);
            IExpression right = GetNodeValue<IExpression>(ctx.right);
            CmpOp cmpOp;
        ...
        public override void ExitInclude_list(MParser.Include_listContext ctx)
        {
        ...
        public override void ExitThen(MParser.ThenContext ctx)
        {
            String name = GetNodeValue<String>(ctx.name);
            StatementList stmts = GetNodeValue<StatementList>(ctx.stmts);
