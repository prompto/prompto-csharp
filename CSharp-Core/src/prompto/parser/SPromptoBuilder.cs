...
namespace prompto.parser
{
	...
	public class SPrestoBuilder : SParserBaseListener
	{
		...
		public override void ExitUUIDLiteral(SParser.UUIDLiteralContext ctx)
		{
			SetNodeValue(ctx, new UUIDLiteral(ctx.t.Text));
		}


		public override void ExitUUIDType(SParser.UUIDTypeContext ctx)
		{
		...
		public override void ExitFilteredListExpression(SParser.FilteredListExpressionContext ctx)
		{
		...
		public override void ExitFiltered_list_suffix(SParser.Filtered_list_suffixContext ctx)
		{
		...
		public override void ExitRead_all_expression (SParser.Read_all_expressionContext ctx)
		{
			IExpression source = this.GetNodeValue<IExpression> (ctx.source);
		...
		public override void ExitRead_one_expression(SParser.Read_one_expressionContext ctx)
		{
			IExpression source = this.GetNodeValue<IExpression>(ctx.source);
