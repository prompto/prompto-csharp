...
namespace prompto.parser
{
    ...
    public class OPromptoBuilder : OParserBaseListener
    {
        ...
        public override void ExitDbIdType(OParser.DbIdTypeContext ctx)
        {
        ...
        public override void ExitTypeType(OParser.TypeTypeContext ctx)
        {
        ...
        public override void ExitMethodRefSelector(OParser.MethodRefSelectorContext ctx)
        {
            String name = GetNodeValue<String>(ctx.name);
            SetNodeValue(ctx, new MethodSelector(name));
        }

        public override void ExitMethodCallSelector(OParser.MethodCallSelectorContext ctx)
        {
        ...
        public override void ExitAbstract_global_method_declaration(OParser.Abstract_global_method_declarationContext ctx)
        {
            IType type = GetNodeValue<IType>(ctx.typ);
        ...
        public override void ExitAbstract_member_method_declaration(OParser.Abstract_member_method_declarationContext ctx)
        {
            IType type = GetNodeValue<IType>(ctx.typ);
            if (type is CategoryType)
                ((CategoryType)type).Mutable = ctx.MUTABLE() != null;
