...
namespace prompto.parser
{
    ...
    public class EPromptoBuilder : EParserBaseListener
    {
        ...
        public override void ExitDoc_entry_list(EParser.Doc_entry_listContext ctx)
        {
        ...
        public override void ExitDoc_entry(EParser.Doc_entryContext ctx)
        {
        ...
        public override void ExitDocKeyIdentifier(EParser.DocKeyIdentifierContext ctx)
        {
        ...
        public override void ExitDocKeyText(EParser.DocKeyTextContext ctx)
        {
        ...
        public override void ExitAbstract_global_method_declaration(EParser.Abstract_global_method_declarationContext ctx)
        {
            IType type = GetNodeValue<IType>(ctx.typ);
        ...
        public override void ExitAbstract_member_method_declaration(EParser.Abstract_member_method_declarationContext ctx)
        {
            IType type = GetNodeValue<IType>(ctx.typ);
            if (type is CategoryType)
                ((CategoryType)type).Mutable = ctx.MUTABLE() != null;
        ...
        public override void ExitCompareExpression(EParser.CompareExpressionContext ctx)
        {
            IExpression left = GetNodeValue<IExpression>(ctx.left);
            IExpression right = GetNodeValue<IExpression>(ctx.right);
            CmpOp cmpOp;
        ...
        public override void ExitIsExpression(EParser.IsExpressionContext ctx)
        {
            ...
            if (ctx.NOT() != null)
            {
                EqOp[] values = (EqOp[])Enum.GetValues(op.GetType());
                int index = Array.IndexOf(values, op);
                op = values[index + 1];
            }
        ...
        public override void ExitInclude_list(EParser.Include_listContext ctx)
        {
        ...
        public override void ExitReadStatement(EParser.ReadStatementContext ctx)
        {
