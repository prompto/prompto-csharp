...
namespace presto.parser
{
	...
	public class OPrestoBuilder : OParserBaseListener
	{
		...
		public override void ExitIsATypeExpression(OParser.IsATypeExpressionContext ctx) {
			IType type = this.GetNodeValue<IType>(ctx.typ);
			IExpression exp = new TypeExpression(type);
			SetNodeValue(ctx, exp);
		}

		public override void ExitIsOtherExpression(OParser.IsOtherExpressionContext ctx) {
			IExpression exp = this.GetNodeValue<IExpression>(ctx.exp);
			SetNodeValue(ctx, exp);
		}
    ...
    public void ExitArgumentAssignmentList (OParser.ArgumentAssignmentListContext ctx)
		...
		{
			SetNodeValue (ctx, new CategoryMethodDeclarationList ());
		}
		...
		public override void ExitConcreteMemberMethod (OParser.ConcreteMemberMethodContext ctx)
		{
			IDeclaration decl = this.GetNodeValue<IDeclaration> (ctx.decl);
			SetNodeValue (ctx, decl);
		}

		public override void ExitAbstractMemberMethod (OParser.AbstractMemberMethodContext ctx)
		{
			IDeclaration decl = this.GetNodeValue<IDeclaration> (ctx.decl);
			SetNodeValue (ctx, decl);
		}

		public override void ExitSetterMemberMethod (OParser.SetterMemberMethodContext ctx)
		{
			IDeclaration decl = this.GetNodeValue<IDeclaration> (ctx.decl);
			SetNodeValue (ctx, decl);
		}

		public override void ExitGetterMemberMethod (OParser.GetterMemberMethodContext ctx)
		{
			IDeclaration decl = this.GetNodeValue<IDeclaration> (ctx.decl);
			SetNodeValue (ctx, decl);
		}
		...
		public override void ExitCSharpPrestoIdentifier (OParser.CSharpPrestoIdentifierContext ctx)
		{
		...
		public override void ExitJavaIdentifierExpression (OParser.JavaIdentifierExpressionContext ctx)
		{
		...
		public override void ExitJavaLiteralExpression (OParser.JavaLiteralExpressionContext ctx)
		{
			JavaExpression exp = this.GetNodeValue<JavaExpression> (ctx.exp);
			SetNodeValue (ctx, exp);
		}
		...
		public override void ExitCSharpLiteralExpression (OParser.CSharpLiteralExpressionContext ctx)
		{
			CSharpExpression exp = this.GetNodeValue<CSharpExpression> (ctx.exp);
			SetNodeValue (ctx, exp);
		}
		...
		public override void ExitJavaCategoryMapping (OParser.JavaCategoryMappingContext ctx)
		{
		...
		public override void ExitCSharpCategoryMapping (OParser.CSharpCategoryMappingContext ctx)
		{
		...
		public override void ExitPython2CategoryMapping (OParser.Python2CategoryMappingContext ctx)
		{
		...
		public override void ExitPython3CategoryMapping (OParser.Python3CategoryMappingContext ctx)
		{
			PythonNativeCategoryMapping map = this.GetNodeValue<PythonNativeCategoryMapping> (ctx.mapping);
			SetNodeValue (ctx, new Python3NativeCategoryMapping (map));
		}

		public override void ExitPython_category_mapping (OParser.Python_category_mappingContext ctx)
		{
	...
	public void ExitPythonGlobalMethodExpression (OParser.PythonGlobalMethodExpressionContext ctx)
		...
		public override void ExitNativeCategoryMappingList (OParser.NativeCategoryMappingListContext ctx)
		{
		...
		public override void ExitNativeCategoryMappingListItem (OParser.NativeCategoryMappingListItemContext ctx)
		{
			NativeCategoryMapping item = this.GetNodeValue<NativeCategoryMapping> (ctx.item);
		...
		public override void ExitNative_category_mappings (OParser.Native_category_mappingsContext ctx)
		{
			NativeCategoryMappingList items = this.GetNodeValue<NativeCategoryMappingList> (ctx.items);
			SetNodeValue (ctx, items);
		}
		...
		public override void ExitOperatorMemberMethod(OParser.OperatorMemberMethodContext ctx) {
		...
		public override void ExitDocument_type (OParser.Document_typeContext ctx)
		{
		...
		public override void ExitFetch_expression (OParser.Fetch_expressionContext ctx)
		{
		...
		public override void ExitCSharpIdentifierExpression (OParser.CSharpIdentifierExpressionContext ctx)
		{
			CSharpExpression exp = this.GetNodeValue<CSharpExpression> (ctx.exp);
			SetNodeValue (ctx, exp);
		}
		...
		public override void ExitJavascript_category_mapping (OParser.Javascript_category_mappingContext ctx)
		{
			String identifier = ctx.identifier ().GetText ();
		...
		public override void ExitJavaScriptCategoryMapping (OParser.JavaScriptCategoryMappingContext ctx)
		{
		...
		public override void ExitJavascriptChildIdentifier (OParser.JavascriptChildIdentifierContext ctx)
		{
		...
		public override void ExitJavascriptIdentifier (OParser.JavascriptIdentifierContext ctx)
		{
			String name = this.GetNodeValue<String> (ctx.name);
